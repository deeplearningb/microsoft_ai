...
from torchvision.models.segmentation import deeplabv3_resnet101 # 많이 무거운 편
from torch.optim import Adam
from torch.nn import CrossEntropyLoss
from torch.utils.data import DataLoader
from voc2012_dataset import customVOCSegmentation
from argparse import ArgumentParser
from learning.learner import SegLearner # learning 폴더 내 learner
...
if __name__=="__main__":
    ...
    learner = SegLearner(model, optimizer, criterion, train_dataloader, valid_dataloader, args) # args.epochs 외에도 받아올 인자들이 많아서 args로 작성
